...
const Signin = () => {
  ...
  const login = async (e) => {
    try {
      ...
      const authResponse = await signinUser(userLogin);
  ...
  return (
    <section className="bg-[#F8F9FA] py-20 dark:bg-dark lg:py-[120px]">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="relative mx-auto max-w-[525px] overflow-hidden shadow-2xl rounded-lg bg-white px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
              <form onSubmit={login} className="relative overflow-hidden">
                <InputBox
                ...
                {/* Toggle Eye Icon */}
                <div
                  className="absolute top-[89px] right-4 cursor-pointer"
                ...
                <div className="mb-10">
                  <button
                    ...
                    //   navigate("/dashboard");
                    // }}
                    className="w-full cursor-pointer rounded-md border border-primary bg-[#33bbff] px-5 py-3 text-base font-medium text-white transition hover:bg-opacity-90"
                  >
                    Sign In
                  </button>
                </div>
